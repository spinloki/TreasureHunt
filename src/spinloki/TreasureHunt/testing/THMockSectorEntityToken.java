...
public class THMockSectorEntityToken implements SectorEntityToken {
    private final String customEntityType;
    private final THMockMarket market;

    public THMockSectorEntityToken(THMockMarket market) {
        this.customEntityType = "";
        this.market = market;
    }

    public THMockSectorEntityToken(String customEntityType, THMockMarket market) {
        this.customEntityType = customEntityType;
        this.market = market;
    }

    public THMockSectorEntityToken(String customEntityType) {
        this.customEntityType = customEntityType;
        this.market = null;
    }
