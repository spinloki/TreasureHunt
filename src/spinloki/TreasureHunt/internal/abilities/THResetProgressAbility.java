package spinloki.TreasureHunt.internal.abilities;

import com.fs.starfarer.api.Global;
import com.fs.starfarer.api.campaign.comm.IntelInfoPlugin;
import com.fs.starfarer.api.impl.campaign.abilities.BaseDurationAbility;
import com.fs.starfarer.api.ui.TooltipMakerAPI;
import spinloki.TreasureHunt.internal.factors.THAbandonCarryoverFactor;
    ...
    protected void activateImpl() {
        for (IntelInfoPlugin intel : Global.getSector().getIntelManager().getIntel()) {
            if (intel instanceof TreasureHuntEventIntel) {
                var carryoverProgress = (int) (((TreasureHuntEventIntel) intel).getProgress() * THRegistry.getSettings().getAbandonCarryoverFactor());
