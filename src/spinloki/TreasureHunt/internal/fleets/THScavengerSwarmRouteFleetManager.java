...
public class THScavengerSwarmRouteFleetManager extends BaseRouteFleetManager {
    ...
    public CampaignFleetAPI spawnFleet(RouteData route) {
        ...
        THFactionConfig.THSwarmFleetCreator fleetDelegate = null;
        if (config != null){
            fleetDelegate = config.getFleetCreator();
        }
        ...
        if (fleetDelegate != null){
            ...
            fleet = config.createDefaultFleet(system, route, route.getMarket(), route.getRandom(), factionId);
        }
        else{
        ...
        THFactionConfig.THSwarmAICreator aiDelegate = null;
        if (config != null){
            aiDelegate = config.getAiCreator();
        }
        if (aiDelegate != null) {
